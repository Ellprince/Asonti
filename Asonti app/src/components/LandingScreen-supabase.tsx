...
import { MessageCircle, User, TrendingUp, Brain, Lightbulb, Target, CheckCircle, Star, Users, AlertCircle } from 'lucide-react';
    ...
    try {
      if (activeTab === 'signup') {
        ...
        if (error) {
          ...
          // For MVP, we can auto-proceed without email verification
          setTimeout(() => {
              ...
              <Card className="border-border shadow-lg">
                ...
                <CardContent className="px-6 pb-6">
                  <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    ...
                    <div className="mt-6 relative" style={{ minHeight: '350px' }}>
